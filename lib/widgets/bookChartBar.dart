...
class BookChartBar extends StatefulWidget {
  BookChartBar({super.key, required this.data});
  final ReportChartModel data;
  final Color leftBarColor = Colors.green;
  final Color rightBarColor = Colors.red;
  final Color avgColor = Colors.yellow;
  @override
  State<StatefulWidget> createState() => BookChartBarState();
}

class BookChartBarState extends State<BookChartBar> {
  ...
  void initState() {
    ...
    final items = List.generate(
        ...
        (i) => makeGroupData(
            i,
            widget.data.result![i].book!.success!.toDouble() / 100,
            widget.data.result![i].book!.cancel!.toDouble() / 100));
