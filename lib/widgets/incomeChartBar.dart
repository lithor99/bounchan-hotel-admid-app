...
class IncomeChartBarState extends State<IncomeChartBar> {
  ...
  void initState() {
    ...
    final items = List.generate(
        ...
        (i) => makeGroupData(
            i,
            double.parse(widget.data.result![i].income!.toString()) / 10000000,
            0));
